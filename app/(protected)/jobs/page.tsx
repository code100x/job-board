...
const JobsPage = () => {
  ...
  return (
    <section className="relative w-full h-fit flex lg:flex-row flex-col gap-2 flex-grow p-2">
      <Sidebar setJobs={setJobs} setLoading={setLoading} />
      <section className="lg:w-[65%] w-full mx-auto h-fit flex flex-col gap-8 rounded-md py-4 px-6">
