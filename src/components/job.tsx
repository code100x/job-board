...
export const Job = ({ job }: { job: JobType }) => {
  return (
    <section className="p-5 m-5 grid gap-5 border border-white-200 border-[1px] rounded-3xl min-h-[55vh] min-w-[25vw] hover:shadow-[0_2px_15px_7px_rgba(0,119,255,0.5)] transition-shadow duration-300 shadow-lg w-full max-w-md mx-auto">
