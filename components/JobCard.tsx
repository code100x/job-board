...
const JobCard = ({ job }: JobCardProps) => {
  ...
  return (
    <div className="max-w-full mx-auto h-fit w-full flex flex-col sm:flex-row items-start gap-4 border border-gray-200 hover:border-gray-300 transition-all shadow-sm rounded-md px-4 py-3 dark:border-gray-600 dark:hover:border-gray-500">
      ...
      <div className="p-2 h-full flex-grow flex flex-col gap-1">
        <h3 className="text-lg sm:text-xl tracking-tight font-semibold text-gray-700 dark:text-gray-200">
          {title}
        </h3>
