      ...
      {words.map((word, index) => (
        <motion.span
          ...
          className={cn(`mr-1 ${className}`, {
            "bg-clip-text text-transparent bg-gradient-to-r from-neutral-900 via-slate-500 to-neutral-400 dark:from-neutral-100 dark:via-neutral-500 dark:to-neutral-700":
              gradient,
          })}
        >
